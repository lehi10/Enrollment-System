        ...
        <td>
                  	    ...
                  	    <div class="row-fluid">
                            ...
                            <div class="span6">
                            	<form name="form1" method="post" action="">
                                	...
                                	<input type="text" name="buscar" class="input-xlarge" autocomplete="off" autofocus placeholder="Buscar Grupos">
                                ...
                                <a href="#nuevo" role="button" class="btn" data-toggle="modal">
                                	<strong><i class="icon-plus"></i> Ingresar Nuevo Grupo</strong>
                                </a>
                                ...
                                <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-header">
    	                                ...
    	                                <h3 id="myModalLabel">Ingresar Nuevo grupo</h3>
                                    </div>
                                    <div class="modal-body">
									    <div class="row-fluid">
	                                        <div class="span6">
                                        		<strong>Descripcion del Grupo</strong><br>
            ...
            <?php
				if(!empty($_POST['nombre'])){
					...
					if(empty($_POST['id'])){
						$oGrado = new Proceso_Grado('',$nombre,$estado);
						$oGrado->guardar();
						echo mensajes('El Grupo "'.$nombre.'" Registrado con Exito','verde');
					}else{
						$id=limpiar($_POST['id']);	
						$oGrado = new Proceso_Grado($id,$nombre,$estado);
						$oGrado->actualizar();
						echo mensajes('El Grupo "'.$nombre.'" Actualizada con Exito','verde');
					}
				}
			?>
            <table class="table table-bordered table-hover">
            	<tr class="info">
                	<td width="12%"><center><strong class="text-info">Codigo del Grupo</strong></center></td>
                    <td width="65%"><strong class="text-info">Descripcion del Grupo</strong></td>
                ...
                <?php
					if(!empty($_POST['buscar'])){
						...
						$pa=mysql_query("SELECT * FROM grado WHERE nombre LIKE '%$buscar%' or id='$buscar'");					
					}else{
						$pa=mysql_query("SELECT * FROM grado");				
					}
               ...
               <div id="a<?php echo $row['id']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	            	<form name="form2" method="post" action="">
                        ...
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3 id="myModalLabel">Actualizar Grupo</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row-fluid">
                                <div class="span6">
